This project is a Machine Learning model that predicts outcomes of Indian Premier League (IPL) cricket matches based on historical data and match statistics.
